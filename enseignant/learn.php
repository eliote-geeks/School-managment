...
if(isset($_POST['valid']))
{
	...
	$_SESSION['first'] = $user['first_en'];
	$_SESSION['last'] = $user['last_en'];
...
<div class="wrapper">
  <section class="form login">
    ...
    <div class="link" align="center"><span>Espace enseignant.. revenir <a href="../Resi/index.php">acceuil</a></span></div>
  </section>
</div>
